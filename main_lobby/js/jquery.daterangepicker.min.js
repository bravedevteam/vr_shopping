		...
		return U(this).off(".datepicker").on("click.datepicker", function (e) {
			...
			setTimeout(function () {
				...
				f.stickyMonths ? function (e) {
					...
					//
					//
					// var _baseYear = f.startDate.getFullYear();
					// var _baseMonth = f.startDate.getMonth()+1;
					// var _m1Year = f.month1.getFullYear();
					// var _m1Month = f.month1.getMonth()+1;
					//
					// console.log(f)
					//
					//
					//
					// console.log(_m1Year)
					// console.log(_m1Month)
					//
					// if(_baseYear == _m1Year){
					// 	if(_baseMonth == _m1Month){
					// 		m.find('.month1 .prev').hide()
					// 	}else{
					// 		m.find('.month1 .prev').show()
					// 	}
					//
					// }else{
					// 	m.find('.month1 .prev').show()
